...
<?php foreach ($output as $data): ?>
  ...
  <div class="box-header with-border">
    ...
    <div class="col-md-6">
      <h3 class="box-title">View Detail C | VISA</h3>
    </div>

    <!-- Exportation sous excel -->
    <div class="col-md-3">
        <a href="<?php echo base_url('visa/export'); ?>" class="form-control btn btn-default"><i class="glyphicon glyphicon glyphicon-floppy-save"></i> Exporter Donnees excel</a>
    </div>
          ...
          <?php
            foreach ($output as $data) {
              ...
              <tr>
                ...
                <td><?php echo $data->projetAviser; ?></td>
...
$(document).ready(function () {
  ...
  $('#butangBack').unbind('click').click(function () {
    $.ajax({
      url : "<?php echo base_url();?>visa/load_view_visa",
